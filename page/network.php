    ...
    <div class="main-content">
        <div class="post">
            ...
            <div class="box">
              <nav>
                <ul>
                  <li><a style="text-decoration: none;" href="network.php"><i class="fa-solid fa-wifi"></i> Wifi</a></li>
                  <li><a href="/network/gps.php"><i class="fa-solid fa-location-dot"></i> GPS</a></li>
                  <li><a href="/network/ip.php"><i class="fa-solid fa-magnifying-glass"></i> IP Address</a></li>
                  <li><a href="/network/router.php"><i class="fa-solid fa-house-signal"></i> Router</a></li>
                  <li><a href="#"></a></li>
                </ul>
              </nav>
            </div>
            <div class="inbox">
              <iframe src="https://fast.com/" width="100%" height="100%"></iframe>
            </div>
        </div>
    </div>
