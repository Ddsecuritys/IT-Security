    ...
    <div class="main-content">
        <div class="post">
            ...
            <div class="box">
              <nav>
                <ul>
                  <li><a href="/page/network.php"><i class="fa-solid fa-wifi"></i> Wifi</a></li>
            ...
            <div class="inbox">
              <div class="rot">
                <nav>
                  <ul>
                    <li><a href="router.php"><i class="fa-solid fa-house-signal"></i> Router</a></li>
                    <li><a href="yip.php"><i class="fa-solid fa-location-crosshairs"></i> Getway</a></li>
                    <li><a href="wireshark.php"><i class="fa-solid fa-khanda"></i> Wireshark</a></li>
                    <li><a href="cmd.php"><i class="fa-solid fa-robot"></i> CMD</a></li>
                  </ul>
                </nav>
              </div>
              <iframe src="/fix/router.html" width="78%" height="100%"></iframe>
            </div>
        </div>
    </div>
