    ...
    <div class="main-content">
        <div class="post">
            ...
            <div class="box">
              <nav>
                <ul>
                  <li><a href="/page/nvr.php"><i class="fas fa-server"></i> NVR Server</a></li>
                  <li><a href="cctv.php"><i class="fa-solid fa-video"></i> Camera</a></li>
                </ul>
              </nav>
            </div>
            <div class="inbox">
              <iframe src="/fix/cctv.html" width="100%" height="100%"></iframe>
            </div>
        </div>
    </div>
